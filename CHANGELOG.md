# Lightstreamer SDK for tvOS Clients Changelog
...
Introduced support for running tvOS Simulator on Apple Silicon Macs.
...
Server with a license of "file" type which enables tvOS Client SDK up to
...
_Compatible with Lightstreamer Server since 6.0.2_<br>
...
The included library is very similar to that for the iOS Client SDK
(Unified API Version) 2.0.0 build 33.
